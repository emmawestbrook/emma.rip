      ...
      <Container className="">
        <div className="py-10 flex ">
          ...
          font-tactile text-center flex-none px-5 pt-2  ">
            ...
            <Image className="pt-2 px-4" src='/sun.png' width='40px' height='40px' />
          </a>
          <a href="/thots" className="text-peachpuff hover:text-orange hover:bg-peachpuff 
          font-mono text-2xl text-center flex-1 border border-peachpuff mx-2 py-5 duration-400 transition-colors">
            <h5 className=" ">thots </h5>
          </a>
          <a href="/arts" className="text-peachpuff hover:text-orange hover:bg-peachpuff font-mono text-2xl
           text-center flex-1 border border-peachpuff mx-2 duration-200 py-5 transition-colors">
            <h5 >arts </h5>
          </a>
